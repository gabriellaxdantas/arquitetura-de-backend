...
def main():
    ...
    secao("2b. Agendando IMEDIATAMENTE após outra consulta do mesmo médico "
          "(esperado: HTTP 409 com o novo buffer de 10 min)")
    print(controller.post_consulta({
        "paciente_id": 3, "medico_id": 1,
        "inicio": "2025-06-10T10:30:00", "fim": "2025-06-10T11:00:00",
    }))
