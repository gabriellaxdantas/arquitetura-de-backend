...
BUFFER_ENTRE_CONSULTAS = timedelta(minutes=10)
...
class Horario:
    ...
    def conflita_com(self, outro: Horario) -> bool:
        """Retorna True se os horários se sobrepõem ou ficam a menos de
        BUFFER_ENTRE_CONSULTAS um do outro (tempo de preparo entre consultas)."""
        return (self.inicio < outro.fim + BUFFER_ENTRE_CONSULTAS
                and self.fim + BUFFER_ENTRE_CONSULTAS > outro.inicio)
